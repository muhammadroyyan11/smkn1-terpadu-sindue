                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3 text-center">
                                        <textarea class="form-control" id="editor" name="deskripsi" rows="3" data-form-field="deskripsi" placeholder="" autofocus="" style="display: none;"><?= $berita['deskripsi'] ?></textarea>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="row">
