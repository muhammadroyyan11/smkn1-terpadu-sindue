                ...
                <div class="tampil-modal"></div>
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                            Proses ubah data ini adalah menghapus data siswa dari tabel jenjang !!!.
                        </div>
                        <form action="<?= base_url('master_siswa/naik_kelas/tabel_del'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer justify-content-between"> 
                                ...
                                <button type="submit" id="simpan" class="btn btn-warning mb-3"><i class="bi bi-arrow-bar-up"></i> Ubah</a></button>
                            </div> 
                        </form>                       
                    </div>
                    <!-- /.card-body -->
