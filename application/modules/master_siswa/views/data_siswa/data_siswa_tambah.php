        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nis" class="form-control" id="nis" maxlength="12" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kode" class="control-label">NISN</label>
                            <input type="text" name="nisn" class="form-control" id="nisn" maxlength="12" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kode" class="control-label">Telp Rumah</label>
                            <input type="text" name="notelp" class="form-control" id="notelp">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="kode" class="control-label">Alamat Rumah</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kode" class="control-label">Thn SKHUN</label>
                ...
                <div class="row">                    
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="kode" class="control-label">Telp Wali</label>
                ...
                <a href="<?= base_url() . 'data_siswa/master_siswa'; ?>" class="btn btn-warning" data-dismiss="modal">Kembali</a>               
