            ...
            <section id="features" class="features">
              ...
              <div class="container">
                <?php foreach ($kontak as $k) :
                  $opsi = $this->db->get_where('m_sekolah', ['npsn' => $k['npsn']])->row_array(); ?>
                  <div class="icon-box text-dark bg-info badge rounded-pill bg-primary">
                      <a target="_blank" href="https://api.whatsapp.com/send?phone=+62<?= $k['no_kontak'] ?>&text=Hello... , <?= $opsi['nama_sekolah'] ?> <?= $sekolah['livechat'] ?>" class="alert-link"> <img class="img-profile rounded-circle" style="width: 3rem;" src="<?= base_url() ?>/panel/assets/img/avatar/avatar-1.png"></a>
                    <div>
