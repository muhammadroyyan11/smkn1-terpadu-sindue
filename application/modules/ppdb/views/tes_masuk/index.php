                    ...
                    <?php foreach ($tugas as $tugas) : ?>
                      <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        ...
                        <h5 class="widget-user-desc">
                          <img class="img-profile rounded-circle" style="width: 3rem;" src="<?= base_url() ?>website/assets/img/materi.png">
                    ...
                    <?php foreach ($materi as $materi) : ?>
                      <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        ...
                        <?php else : ?>
                          <span class="btn btn-danger btn-sm">Tidak Aktif</span>
                        <?php endif; ?>
                        <a class="btn btn-success btn-sm" href="<?= base_url() . $this->uri->segment(1, 0) ?>/tes_masuk/quiz/<?= $materi['id_materi'] ?>">Kerjakan</a>
                      </div>
                    <?php endforeach ?>
                    <!-- end notif quiz -->
                  </div>
