  ...
  <div class="marginpage">
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <div class="content-category difle-l mb-5">
                <div class="category-icon">
                  <img src="<?= base_url() ?>panel/dist/upload/logo/<?= $sekolah['logo'] ?>"/>
                </div>
                <p><?= $title; ?></p>
              </div>
              <div class="head-content mb-15"> <?= $title; ?> </div>	
            
              <div class="imglist"></div>
              <div class="wrespon dropdown mlr-min-3 statnav mb-15">
              <?php foreach ($belajara as $o) : ?>  
                <div class="statnav-item">
                  <div id="heading" role="tab">
                    <a href="<?= $o->link ?>">
                      <div class="statnav-title difle-c"><i class="<?= $o->gambar ?>"></i><h1><?= $o->judul ?></h1></div>
                    </a>
                  </div>		
                </div>
              <?php endforeach ?>				
