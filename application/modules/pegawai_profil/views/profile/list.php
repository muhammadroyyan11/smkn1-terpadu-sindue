            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="<?= base_url() ?>panel/dist/upload/profil_user/<?= $pegawai['img'] ?>" alt="Profile" class="rounded-circle">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <div class="custom-file">
                                                        <img src="<?= base_url() ?>panel/dist/upload/profil_user/<?= $pegawai['img'] ?>" class="img-thumbnail" height="100px" width="100px">
