...
class Web_p5 extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        cek_akses();
        $this->load->model('p5_model', 'home');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('p5_v', $data);
        $this->load->view('website/footer', $data);
        $this->benchmark->mark('code_end');
    }

    public function detail_p5($id)
    {
        $this->benchmark->mark('code_start');
        $data['title'] = 'Detail P5 SMK';
        $data['home'] = 'P5 SMK';
        $data['subtitle'] = $data['title'];
        $data['sekolah'] = $this->home->sekolah();
        $data['kepsek'] = $this->db->get('profil_kepsek')->row_array();
        $data['data'] = $this->db->get_where('profil_galeri', ['id_galeri' => $id])->row_array();
        $data['p5'] = $this->home->profil_p5_detail($id);
        $data['p5_post'] = $this->home->profil_p5();
        $data['belajara'] = $this->home->profil_belajar();
