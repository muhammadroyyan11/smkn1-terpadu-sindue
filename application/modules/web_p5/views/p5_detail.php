		...
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <div class="content-category difle-l mb-10">
                ...
                <div class="head-content mb-10"><?= $p5['p5'] ?></div>
                <div class="newarticle-meta-cont difle-l" style="margin:0 0 15px !important;">
                  <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                    ...
                    <h3><?= date('d-m-Y', strtotime($p5['datecreate'])); ?></h3>
                  </div>
                  <!-- <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                ...
                <div class="imglist">                    
                  <div class="image-box standar-image">
                    <img src="<?= base_url() ?>/panel/dist/upload/profil_p5/<?= $p5['gambar'] ?>"/>
                  </div>		
                </div>

                <div class="relhid content-isi pt-15 pb-15">
                  <p class="card-text"><?= $p5['deskripsi'] ?></p>
                </div>
                <hr>
