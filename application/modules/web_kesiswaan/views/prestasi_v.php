                ...
                <div class="relhid">                 
                      ...
                      <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="foto-table"><div class="small-photo imagefull"><a href="<?= base_url() ?>/panel/dist/upload/profil_prestasi/<?= $p->gambar ?>"  data-fancybox="images" data-caption="<?= $p->judul ?>"><img src="<?= base_url() ?>/panel/dist/upload/profil_prestasi/<?= $p->gambar ?>"></a></div></td>
                            <td>
                                <b><?= $p->judul ?></b><br/>
                  ...
                  <div class="no-print">
                    <div class="relhid difle-c mt-15 mb-15">
                      <a class="difle-c" href="<?= base_url('web_kesiswaan/prestasi_detail')?>" title='Lihat Lebih Banyak'>
