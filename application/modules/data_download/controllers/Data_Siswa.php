...
class Data_Siswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Data Download Siswa';
        ...
        $data['data_download'] = $this->download->get('media', ['type' => 'Data siswa'])->result_array();
    ...
    {
        $this->benchmark->mark('code_start');
        $data['title'] = 'Tambah Data Download siswa';
        $data['home'] = 'Data Download';
        $data['subtitle'] = $data['title'];
        $data['main_menu'] = main_menu();
        $data['sub_menu'] = sub_menu();
    ...
    public function add_action()
    {
        ...
        $config['file_name']            = 'siswa-' . date('ymd');
        ...
        redirect('data_download/data_siswa');
    }
