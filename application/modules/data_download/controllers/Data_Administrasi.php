...
class Data_Administrasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Data Download Administrasi';
        ...
        $data['data_download'] = $this->download->get('media', ['type' => 'Data Administrasi'])->result_array();
    ...
    {
        $this->benchmark->mark('code_start');
        $data['title'] = 'Tambah Data Download Administrasi';
        $data['home'] = 'Data Download';
        $data['subtitle'] = $data['title'];
        $data['main_menu'] = main_menu();
        $data['sub_menu'] = sub_menu();
    ...
    public function add_action()
    {
        ...
        $config['upload_path']          = './assets/uploads/administrasi/';
        $config['allowed_types']        = 'rar|xls|xlsx|doc|docs|pdf|zip|jpg|jpeg|png|gif';
        $config['max_height']           = 10000;
        $config['file_name']            = 'administrasi-' . date('ymd');
        ...
        redirect('data_download/data_administrasi');
    }
