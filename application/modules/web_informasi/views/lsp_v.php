  ...
  <div class="marginpage">
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <div class="head-content">Data <?= $title; ?></div>	
              ...
              <div class="data-area bgwhite">               
                ...
                <div class="relhid sub-pagetitle difle-c">
                  <div class="relative">
                    <div class="pagetitle-icon"><img src="<?= base_url(); ?>panel/dist/upload/logo/<?= $lsp['logo'] ?>"/></div>
                ...
                <div class="data-area bgwhite">
                  <div class="comment-notif difle-c mb-15">                    
                    <p class="card-text">Alamat : <?= $sekolah['alamat']?></p>
                  </div>
                  <div class="relhid mb-15">
                    <div class="difle-c">
                    <div class="headarrow difle-c c1" style="margin-top:10px;margin-bottom:10px;"><h1>Profile LSP</h1></div>
                    </div>
                    <div class="table-responsive organisasi">
                      <table class="custom-table withline" style="width:100%;">
                      <tr>
                          <td style="width:15%;text-align:justife;">No Sk</td>
                          <td style="width:5%;text-align:center;">:</td>
                          <td style="width:80%;text-align:justife;"><?= $lsp['no_sk']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">No Lisensi</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['no_lisensi']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">Jenis</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['jenis']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">No Telp</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['no_telp']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">No Hp</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['no_hp']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">No Fax</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['no_fax']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">Email</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['email']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">Website</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['website']?></td>
                        </tr>
                        <tr>
                          <td style="text-align:justife;">Masa Berlaku SK</td>
                          <td style="text-align:center;">:</td>
                          <td><?= $lsp['masa_berlaku']?></td>
                        </tr>
                      </table>
                    </div>
                  </div>
                  <div class="relhid mb-15">
                    <div class="difle-c">
                    <div class="headarrow difle-c c1" style="margin-top:10px;margin-bottom:10px;"><h1>DATA TUK</h1></div>
                    </div>
                    <div class="table-responsive organisasi">
                      <table class="custom-table withline" style="width:100%;">
                        <thead>
                        <tr>
                          ...
                          <th>Kode</th>
                          <th class="text-center">Jenis TUK</th>
                          <th>Nama TUK</th>   
                          <th>Alamat</th>    
                        </tr>
                        </thead>
                        ...
                        <?php
                            ...
                            foreach ($tuk as $sk) :
                                ...
                                <tr>
                                    ...
                                    <td><?= $sk['kode'] ?></td>
                                    <td class="text-center"><?= $sk['jenis_tuk'] ?></td>
                                    <td><?= $sk['nama_tuk'] ?></td>
                                    <td><?= $sk['alamat'] ?></td>                                          
                                </tr>
                            <?php endforeach ?>
                  ...
                  <div class="relhid mb-15">
                    <div class="difle-c">
                      <div class="headarrow difle-c c1" style="margin-bottom:10px;"><h1>DATA ASESOR</h1></div>
                    </div>
                    <div class="table-responsive organisasi">
                      <table class="custom-table withline" style="width:100%;">
                        <thead>
                  ...
                  <div class="relhid mb-15">
                    <div class="difle-c">
                      <div class="headarrow difle-c c1" style="margin-bottom:10px;"><h1>DATA SKEMA</h1></div>
                    </div>
                    <div class="table-responsive organisasi">
                      <table class="custom-table withline" style="width:100%;">
                        <thead>
                        ...
                        <tbody>
                          <?php
                            ...
                            <tr>
                              <td class="text-center"><?= $no; ?></td>
                              <td><?= $sk['kode_skema'] ?></td>
                              <td class="text-center"><?= $sk['nama_skema'] ?></td>                                            
                              <td class="text-center"><?= $sk['kategori'] ?></td>
                              <td class="text-center"><?= $sk['bidang'] ?></td>
                              <td class="text-center"><?= $sk['mea'] ?></td>
                              <td class="text-center"><?= $sk['unit'] ?></td>                                            
                            </tr>
                          <?php endforeach ?>                                
                        </tbody>
                      </table>
