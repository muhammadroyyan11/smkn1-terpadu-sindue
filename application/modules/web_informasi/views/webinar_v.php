			...
			<div class="container-sticky">
              ...
              <div class="data-area bgwhite">               
                <div class="relhid"> 
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="card-responsive">
                              <form action="" id="form-webinar">
                                <div class="row">
                                  <div class="col-lg-8 mt-4 mt-lg-0">
                                    <div class="">
                                      <input class="form-control" type="text" name="nip" id="nip" placeholder="Masukkan NIP/NRPTK/NUPTK">
                                    </div>
                                  </div>
                  ...
                  <p class="fst-italic text-danger"> * Untuk menampilkan Sertifikat Webinar -> masukkan NIP/NRPTK/NUPTK -> klik cari data</p>                                       
                  <div class="data-area bgwhite">
                    <div class="comment-notif difle-c mb-15">
                      <div class="col-lg-8 mt-4 mt-lg-0">
