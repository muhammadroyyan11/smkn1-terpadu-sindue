		...
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <div class="wrespon non-brd-pd mlr-min-5 mt-15">
                <?php foreach ($filem as $p) : ?>                
                  <div class="column2">
                    <div class="framefoto trans-h">
                      <div class="inner-foto">
                        <a href="<?= $p['url_video'] ?>"  data-fancybox="images" data-caption="<?= $p['judul_video'] ?>">
                        <div class="mat">
                          <div class="image-medium imagefull">
                              <img class="trans-def" src="<?= base_url()?>panel/dist/upload/profil_video/<?= $p['gambar_video']?>">
                          </div>                          
                        </div>
                        </a>
                      </div>
                ...
                <div class="no-print">
                  <div class="relhid difle-c mt-15 mb-15">
                    <a class="difle-c" href="<?= base_url('web_galery/video_all')?>" title='Lihat Lebih Banyak'>
