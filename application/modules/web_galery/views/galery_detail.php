		...
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <div class="content-category difle-l mb-10">
                <div class="category-icon"><img src="<?= base_url() ?>panel/dist/upload/logo/<?= $sekolah['logo'] ?>"/></div>
                  <p><?= $title ?></p>
                </div>
                <div class="head-content mb-10"><?= $data['judul_galeri'] ?></div> 
                <div class="newarticle-meta-cont difle-l" style="margin:0 0 15px !important;">
                  <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                    ...
                    <h3><?= date('d-m-Y', strtotime($data['datecreate'])); ?></h3>
                  </div>
                </div>              
                <p><?= $data['deskripsi'] ?></p>
                
                <div class="wrespon non-brd-pd mlr-min-5 mt-15">
                <?php foreach ($gambar as $p) : ?>                
                  <div class="column2">
                    <div class="framefoto trans-h">
                      <div class="inner-foto">
                        <a href="<?= base_url() ?>/panel/dist/upload/profil_galery/<?= $p['foto'] ?>"  data-fancybox="images" data-caption="<?= $data['judul_galeri'] ?>">
                        <div class="mat">
                          <div class="image-medium imagefull">
                              <img class="trans-def" src="<?= base_url() ?>/panel/dist/upload/profil_galery/<?= $p['foto'] ?>">
                          </div>                          
                        </div>
                        </a>
                      </div>
