                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="login-box" style="margin-top: 40px;">
                            ...
                            <div class="login-box-body" style="border-top: 10px solid rgb(0, 110, 127);border-top-left-radius: 20px; box-shadow: 0px 3px 6px 0px #3c8dbc;">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="pt-4 pb-3">
                            ...
                            <p class="text-center" style="background-color: rgb(0, 110, 127); color: #FFFFFF; border-bottom-right-radius: 20px; box-shadow: 0px 1px 6px 0px #3c8dbc;">
