...
class Web_jurusan extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        cek_akses();
        $this->load->model('Jurusan_model', 'home');
    }
    ...
    public function detail_jurusan($id)
    {
        ...
        $data['sidebar'] = $this->home->profil_jurusan();
        $data['jurusan'] = $this->home->profil_jurusan_detail($id);
        $data['belajara'] = $this->home->profil_belajar();
        ...
        // die;
        $this->load->view('website/header', $data);
        $this->load->view('jurusan_detail', $data);
        $this->load->view('website/footer', $data);
        $this->benchmark->mark('code_end');
    }
    // end 
