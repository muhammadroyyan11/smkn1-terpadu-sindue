  ...
  <div class="marginpage">
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <!-- <div class="relhid sub-pagetitle difle-c">
                <div class="relative">
                  <div class="pagetitle-icon"><img src="<?= base_url() ?>panel/dist/upload/logo/<?= $sekolah['logo'] ?>"/></div>
              ...
              <div class="imglist"></div>
                ...
                <div class="relhid pagestickymain trans-w">                
                  <div class="wrespon mlr-min-5 mt-15">
                  <?php foreach ($jurusan as $e) : ?>
                    <div class="column2 archive bgwhite">
                      <a href="<?= base_url() ?>web_jurusan/detail_jurusan/<?= $e->id_jurusan ?>">
                        <div class="relhid wrespon mlr-min-5">
                          <div class="newsrow-left">
                            <div class="newsrow-image">
                              <div class="imagefull">
                                  <img src="<?= base_url() ?>/panel/dist/upload/profil_jurusan/<?= $e->gambar ?>">
                              </div>
                            </div>
                          </div>
                          <div class="newsrow-right">
                            <div class="relhid news-posting difle-l">
                              <div class="news-date difle-c" style="border-radius:3px;"><?= date('d', strtotime($e->datecreate)); ?></div>
                              <p><?= date('m-Y', strtotime($e->datecreate)); ?></p>
                            </div>
                            <h2><?= $e->jurusan ?></h2>
                            <p class="card-text"><?= (str_word_count($e->deskripsi) > 15 ? substr("$e->deskripsi", 0, 100) . "[...]" : "$e->deskripsi")  ?></p>
                            <!-- <div class="newarticle-meta-cont difle-l" style="margin:0;">
                              <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                                ...
                                <h3>112 Kali dibuka</h3>
                              </div>
                              <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                                <svg viewBox="0 0 24 24" style="margin-top:3px;"><path d="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M17,11V9H15V11H17M13,11V9H11V11H13M9,11V9H7V11H9Z" /></svg></svg>
                                <h3>0</h3>
                              </div>
                            </div> -->
                          </div>
