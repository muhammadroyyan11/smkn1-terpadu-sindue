...
class Quiz extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_tesmasuk/quiz/quiz_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_js');
    ...
    public function tambah()
    {
        ...
        $data = [
            ...
            'mapel' => $this->db->get('ppdb_mapel')->result_array(),
            'guru' => $guru,
            'kelas' => $this->db->get_where('m_kelas')->result_array(),
        ];

        // var_dump($data['pegawai']);
        // die;
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_css');
        $this->load->view('ppdb_admin_tesmasuk/quiz/quiz_add', $data);
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_js');
    }
    ...
    function edit($id)
    {
        ...
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_css');
        $this->load->view('ppdb_admin_tesmasuk/quiz/quiz_edit', $data);
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_js');
    }
    ...
    function delete($id)
    {
        ...
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_css');
        $this->load->view('ppdb_admin_tesmasuk/quiz/quiz_delete', $data);
        $this->load->view('ppdb_admin_tesmasuk/quiz/list_js');
    }
    ...
    public function simpan_tambah_quiz()
    {
        ...
        redirect('ppdb_admin_tesmasuk/quiz');
    }
    ...
    public function soal($id)
    {
        ...
        // die;  
        $this->load->view('layout/header-top', $data);
        $this->load->view('ppdb_admin_tesmasuk/soal/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_tesmasuk/soal/soal_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_tesmasuk/soal/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function tambah_soal($id)
    {
        ...
        // die;
        $this->load->view('ppdb_admin_tesmasuk/soal/list_css');
        $this->load->view('ppdb_admin_tesmasuk/soal/soal_add', $data);
        $this->load->view('ppdb_admin_tesmasuk/soal/list_js');
    }
    ...
    public function delete_soal($id)
    {
        ...
        // die;
        $this->load->view('ppdb_admin_tesmasuk/soal/list_css');
        $this->load->view('ppdb_admin_tesmasuk/soal/soal_delete', $data);
        $this->load->view('ppdb_admin_tesmasuk/soal/list_js');
    }
    ...
    public function add_soal()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        $id_materi = $this->input->post('id_materi');
        redirect('ppdb_admin_tesmasuk/quiz/soal/' . $id_materi . '');
    }
    ...
    public function hasil($id)
    {
        ...
        // die;  
        $this->load->view('layout/header-top', $data);
        $this->load->view('ppdb_admin_tesmasuk/soal_hasil/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_tesmasuk/soal_hasil/soal_hasil_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_tesmasuk/soal_hasil/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    // end Hasil quiz
