                            ...
                            foreach ($materi as $materi) : ?>
                                <div class="col-md-4">
                                    ...
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            <a href="<?= base_url() . $this->uri->segment(1, 0) ?>/quiz/soal/<?= $materi['id_materi'] ?>" class="card-link">Soal</a>
                                            <a href="<?= base_url() . $this->uri->segment(1, 0) ?>/quiz/hasil/<?= $materi['id_materi'] ?>" class="card-link">Hasil</a>
