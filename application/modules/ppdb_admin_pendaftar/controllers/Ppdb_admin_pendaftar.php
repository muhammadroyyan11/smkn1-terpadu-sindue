...
class Ppdb_admin_pendaftar extends CI_Controller
{
    ...
    public function data_pendaftar()
    {
        ...
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/data_pendaftar_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/list_js');
    ...
    public function tambah_pendaftar()
    {
        ...
        $data['kls'] = $this->db->get('m_kelas')->result_array();
        $data['jenis'] = $this->psb->getAllJenis();
        $data['periode'] = $this->psb->getAllPeriode();
        $data['asal_sekolah'] = $this->psb->getAsalSekolah();

        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/list_css');
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/data_pendaftar_add', $data);
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/list_js');
    }
    ...
    function edit_pendaftar($id)
    {
        ...
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/list_css');
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/data_pendaftar_edit', $data);
        $this->load->view('ppdb_admin_pendaftar/data_pendaftar/list_js');
    }
    ...
    public function simpan_tambah_pendaftar()
    {
        ...
        redirect('ppdb_admin_pendaftar/data_pendaftar');
    }
    ...
    public function mpdf_cetak($id)
    {
        ...
        $sekolah = $this->db->get_where('m_sekolah', ['npsn' => $this->session->userdata('npsn')])->row_array();
        $data['daftar'] = $this->db->get_where('ppdb_daftar', ['id_daftar' => $id])->row_array();
        // sikap       
    ...
    public function pendaftar_diterima()
    {
        ...
        // die;
        $this->load->view('layout/header-top', $data);
        $this->load->view('ppdb_admin_pendaftar/pendaftar_diterima/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_pendaftar/pendaftar_diterima/pendaftar_diterima_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_pendaftar/pendaftar_diterima/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function pendaftar_cadangan()
    {
        ...
        // die;
        $this->load->view('layout/header-top', $data);
        $this->load->view('ppdb_admin_pendaftar/pendaftar_cadangan/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_pendaftar/pendaftar_cadangan/pendaftar_cadangan_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_pendaftar/pendaftar_cadangan/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function batal_pendaftar($id)
    {
        ...
        $this->load->view('ppdb_admin_pendaftar/pendaftar_diterima/list_css');
        $this->load->view('ppdb_admin_pendaftar/pendaftar_diterima/pendaftar_batal', $data);
        $this->load->view('ppdb_admin_pendaftar/pendaftar_diterima/list_js');
    }
    ...
    public function export_excel_pendaftaran()
    {
        ...
        foreach ($data['daftar'] as $s) {
            ...
            $object->getActiveSheet()->setCellValue('C' .  $baris_a, "'$nisn");
            $object->getActiveSheet()->setCellValue('D' .  $baris_a, "'$nik");
            $object->getActiveSheet()->setCellValue('E' .  $baris_a, "'$kk");
