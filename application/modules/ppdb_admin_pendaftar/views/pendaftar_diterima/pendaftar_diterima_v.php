                    ...
                    <div class="card-header">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <?php if ($cek_akses['role_id'] == 1) : ?>
                                <a class="btn btn-success mb-3" href="<?= base_url() . $this->uri->segment(1, 0) ?>/export_excel_diterima"><i class="fa fa-download"></i> Export Excel</a>
                            <?php endif ?>
                        </div>                            
                    </div>   
