                            ...
                            <tbody>
                                ...
                                foreach ($daftar as $daftar) :
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning btn-edit mb-2" data-id="<?= $daftar['id_daftar'] ?>">
                                                <i class=" fas fa-edit"></i>
                                            </button>
                                            <a target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="detail siswa" href="<?= base_url() . $this->uri->segment(1, 0) ?>/mpdf_cetak/<?= $daftar['id_daftar'] ?>" class="btn btn-sm btn-success mb-2"><i class="fas fa-eye"></i></a>
                                            <a href="<?= base_url() . $this->uri->segment(1, 0) ?>/deldata_pendaftar/<?= $daftar['id_daftar'] ?>" class="btn btn-sm btn-danger btn-hapus mb-2"><i class="fa fa-trash-alt"></i> </a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
