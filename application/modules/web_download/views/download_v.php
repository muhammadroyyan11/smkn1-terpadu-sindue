        ...
        <div class="asimse pageopen">
                                    ...
                                    <div class="relhid widget-height bggrad-tb" style="border:none;">
                                        <div class="relhid p-10">
                                            <table style="width: 100%;" class="deftable-dotborder">
                                                <tr>
                                                    <td style="width:45% !important;">Hari ini</td>
                                                    <td style="width:10px;text-align:center;">:</td>
                                                    <td><?php echo $pengunjunghariini ?> </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:45% !important;">Total</td>
                                                    <td style="width:10px;text-align:center;">:</td>
                                                    <td><?php echo $totalpengunjung ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="width:45% !important;">Online</td>
                                                    <td style="width:10px;text-align:center;">:</td>
                                ...
                                <div class="boxprime aprofile nimate__bounceIn animated">
                                    <div class="mt-15">
                                        <div class="relhid profile-inner mb-15">
                                            <div class="profile-icon"><svg viewBox="0 0 16 16">
                                        ...
                                        <div class="headarrow" style="margin:0 0 5px;">
            ...
            <noscript>
                <div class="scriptmati difle-c">
                    <div>
                        <div class="difle-c">
                            <h2>INFO...</h2><svg class="popin" width="20px" height="20px" viewBox="0 0 64 64" style="fill:#f6b530;">
            ...
            <script type="text/javascript">
                $(window).load(function() {
                    $("#masihloading").delay(100).fadeOut("slow");
                })
            </script>
                    ...
                    <div class="wrespon">
                        <div class="headleft difle-c desk-v">
                            <div class="headtitle OpaC">
                                <div class="relative">
                                    <div class="bg-anim">
                                        <div class='bgcircle small shade1'></div>
                                        <div class='bgcircle medium shade2'></div>
                                        <div class='bgcircle large shade3'></div>
                                    </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="headgraph absfulltop desk-v">
                                    ...
                                    <div class="graph1-c">
                                        <svg viewBox="0 0 908.000000 1234.000000">
                                            <g transform="translate(0.000000,1234.000000) scale(0.100000,-0.100000)" stroke="none">
                                                <path d="M2088 6273 c-496 -498 -773 -782 -786 -808 -25 -52 -34 -94 -33 -161 1 -112 -24 -84 816 -924 l775 -775 745 745 c709 708 748 749 783 819 35 70 37 80 36 165 0 71 -5 102 -23 141 -18 41 -152 180 -779 808 -416 416 -759 757 -762 757 -3 0 -350 -345 -772 -767z" />
                                                <path d="M4614 5030 c-78 -11 -147 -37 -211 -79 -36 -24 -293 -274 -669 -652 -683 -687 -658 -656 -657 -794 0 -50 6 -83 21 -115 16 -34 201 -224 719 -742 l698 -697 59 -17 c78 -22 151 -14 230 25 53 26 147 116 732 703 532 534 676 683 695 723 19 41 24 66 24 140 0 80 -3 95 -27 135 -15 25 -302 320 -655 672 -491 490 -639 632 -679 652 -85 42 -189 59 -280 46z" />
                                                <path d="M2134 2697 c-647 -648 -816 -822 -835 -862 -20 -41 -24 -66 -24 -140 0 -80 3 -95 27 -135 15 -25 325 -343 715 -731 652 -651 691 -688 742 -704 67 -22 158 -16 227 14 40 18 164 136 702 674 359 359 666 672 682 697 42 66 63 151 58 229 -10 131 15 102 -727 846 -738 739 -722 721 -745 857 l-11 68 -811 -813z" />
                                            </g>
                                        </svg>
                                    </div>
                                </div>
                ...
                <div class="marginpage">
                    <div class="runtext-content">
                        <div class="runtext-head difle-l">
                            <svg class="popin" viewBox="0 0 64 64">
                                <path d="M36.989 42.439H27.01L23 2h18z"></path>
                                <ellipse cx="31.999" cy="54.354" rx="7.663" ry="7.646"></ellipse>
                            </svg>
                                                    ...
                                                    <table class="custom-table withline" style="width:100%;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="foto-table mini-foto" style="text-align:center;">
                                                                    Action
                                                                </th>
                                                                <th>Nama File</th>
                                                                <th>Size</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($download as $key => $data) : ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="foto-table">
                                                                        <div class="small-photo imagefull"><a href="<?= base_url() ?>/assets/uploads/<?= $type?>/<?= $data['uploads_file']?>">Unduh</a></div>
                                                                    </td>
                                                                    <td>
                                                                        <b><?= $data['name_file'] ?></b><br />
                                                                    </td>
                                                                    <td>
                                                                        <b><?= $data['size'] ?> kb</b><br />
                                                                    </td>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="absensi difle-c">
                                                                        <div class="absensi-box bgorange difle-c">
                                                                            <a href="<?= base_url() ?>web_profil/sambutan" class="text-white">
                                                                                <p>Sambutan</p>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="wrespon">
                                                    <div class="galeri-head difle-c">
                                                        <div>
                                                            ...
                                                            <a href="<?= base_url() ?>web_galery/galery">
                                                                <p>Lihat Semua Album</p>
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="statright-content">
                                                            <a href="#">
                                                                <div class="icon-item difle-l">
                                                                    <div class="icon-stat difle-c bgyellow"><svg viewBox="0 0 24 24">
                                                            ...
                                                            <a href="#">
                                                                <div class="icon-item difle-l">
                                                                    <div class="icon-stat difle-c bgpink"><svg viewBox="0 0 16 16">
                                                            ...
                                                            <a href="#">
                                                                <div class="icon-item difle-l">
                                                                    <div class="icon-stat difle-c bgcyan"><svg viewBox="0 0 16 16">
                                                            ...
                                                            <a href="#">
                                                                <div class="icon-item difle-l">
                                                                    <div class="icon-stat difle-c bgblue"><svg viewBox="0 0 16 16">
                                                            ...
                                                            <a href="#">
                                                                <div class="icon-item difle-l">
                                                                    <div class="icon-stat difle-c bg2"><svg viewBox="0 0 16 16">
                                                            ...
                                                            <a href="#">
                                                                <div class="icon-item difle-l">
                                                                    <div class="icon-stat difle-c bgviola"><svg viewBox="0 0 16 16">
                ...
                <div class="relhid">
                    <div class="visitor-bottom difle-l">
                        ...
                        <div class="visitor-bottom-right">
                            <div id="flip">
                                <div>
                                    <div>Hari ini : <b><?php echo $pengunjunghariini ?> orang</b></div>
                                </div>
                                <div>
                                    <div>Total : <b><?php echo $totalpengunjung ?> orang</b></div>
                                </div>
                                <div>
                                    <div>Online : <b><?php echo $pengunjungonline ?> orang</b></div>
                                </div>
                            </div>
                        </div>
                    </div>
