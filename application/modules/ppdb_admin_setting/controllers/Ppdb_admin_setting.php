...
class Ppdb_admin_setting extends CI_Controller
{
    ...
    public function master_sekolah()
    {
        ...
        $this->load->view('ppdb_admin_setting/master_sekolah/sekolah_v', $data);
    ...
    public function simpan_tambah()
    {
        ...
        redirect('ppdb_admin_setting/master_sekolah');
    }
    ...
    public function master_jenis_daftar()
    {
        ...
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_setting/jenis_daftar/jenis_daftar_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function simpan_tambah_jenis()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        redirect('ppdb_admin_setting/master_jenis_daftar');
    }
    ...
    public function master_kuota()
    {
        ...
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_setting/master_kuota/master_kuota_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function simpan_tambah_kuota()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        redirect('ppdb_admin_setting/master_kuota');
    }
    ...
    public function master_periode()
    {
        ...
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_setting/master_periode/master_periode_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function simpan_tambah_periode()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        redirect('ppdb_admin_setting/master_periode');
    }
    ...
    public function master_mapel()
    {
        ...
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_setting/master_mapel/master_mapel_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function simpan_tambah_mapel()
    {
        ...
        redirect('ppdb_admin_setting/master_mapel');
    }
    ...
    public function master_bank()
    {
        ...
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_setting/master_bank/master_bank_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function simpan_tambah_bank()
    {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        redirect('ppdb_admin_setting/master_bank');
    }
