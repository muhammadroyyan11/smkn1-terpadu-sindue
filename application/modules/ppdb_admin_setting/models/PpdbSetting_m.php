...
class PpdbSetting_m extends CI_Model
{
    ...
    public function simpan_tambah_mapel()
    {
        ...
        // insert ke table user
        $cek = $this->db->get_where('ppdb_mapel',['id_mapel' => $id_mapel])->row_array();
        if($cek['id_mapel'] == ''){
            $this->db->insert('ppdb_mapel', $data);
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
         } else {
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Mapel sudah ada !!!</div>');
         }
    ...
    public function simpan_tambah_bank()
    {
        ...
        // insert ke table user
        $cek = $this->db->get_where('ppdb_bank',['kode_bank' => $kode_bank])->row_array();
        if(empty($cek['kode_bank'])){
            $this->db->insert('ppdb_bank', $data);
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Berhasil tambah data !!!</div>');
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert"> Nama Bank sudah ada !!!</div>');
        }        
    }
