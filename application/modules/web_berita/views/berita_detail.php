		...
		<div class="stickybox">
			<div class="container-sticky">
              ...
              <div class="content-category difle-l mb-10">
                ...
                <div class="head-content mb-10"><?= $berita['judul_artikel'] ?></div>
                <div class="newarticle-meta-cont difle-l" style="margin:0 0 15px !important;">
                  <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                    ...
                    <h3><?= date('d-m-Y', strtotime($berita['tanggal_terbit'])); ?></h3>
                  </div>
                  <!-- <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                  ...
                  <div class="newarticle-meta difle-l" style="margin:5px 10px 0 0;">
                    ...
                    <h3><?= $berita['user_update'] ?></h3>
                  </div>
                </div>                
                <div class="imglist">                    
                  <div class="image-box standar-image">
                    <img src="<?= base_url() ?>/panel/dist/upload/profil_berita/<?= $berita['gambar'] ?>"/>
                  </div>		
                </div>
