              ...
              <div class="imglist"></div>
                        ...
                        <div class="relhid wrespon mlr-min-5">
                          ...
                          <div class="newsrow-right">
                            <div class="relhid news-posting difle-l">
                              <div class="news-date difle-c" style="border-radius:3px;"><?= date('d', strtotime($e->tanggal_terbit)); ?></div>
                ...
                <div class="no-print">
                  <div class="relhid difle-c mt-15 mb-15">
                    <a class="difle-c" href="<?= base_url('web_berita/berita_all')?>" title='Lihat Lebih Banyak'>
                      <div class="btcustom bttall difle-c bg2 trans-w no-print">
                        ...
                        <p style="margin:0 0 0 5px;">Lihat Lebih Banyak</p>
                      </div>
                    </a>
                  </div>
                </div>                     
