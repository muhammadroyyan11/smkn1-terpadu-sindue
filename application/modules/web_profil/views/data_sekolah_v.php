              ...
              <div class="imglist"></div>
                <div class="relhid content-isi pt-15 pb-15">
                  <div class="comment-notif difle-c mb-15">
                    <table class="tablemedium" style="width:100%;text-align:left;">                   
                      <tr>
                        <td>Nama</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['nama_sekolah'] ?></td>
                      </tr>
                      <tr>
                        <td>NPSN</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['npsn'] ?></td>
                      </tr>
                      <tr>
                        <td>Alamat</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['alamat'] ?></td>
                      </tr>
                      <tr>
                        <td>Kode Pos</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['kodepos'] ?></td>
                      </tr>
                      <tr>
                        <td>Kecamatan/Kota (LN)</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['kecamatan'] ?></td>
                      </tr>
                      <tr>
                        <td>Kab.-Kota/Negara (LN)</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['kota'] ?></td>
                      </tr>
                      <tr>
                        <td>Propinsi/Luar Negeri (LN)</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['provinsi'] ?></td>
                      </tr>
                      <tr>
                        <td>Status Sekolah</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['sekola_status'] ?></td>
                      </tr>
                      <tr>
                        <td>Waktu Penyelenggaraan</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['sekolah_waktu'] ?></td>
                      </tr>
                      <tr>
                        <td>Jenjang Pendidikan</td><td style="width:15px;text-align:center;">:</td>
                        <td> <?= $sekolah['sekolah_jenjang'] ?></td>
                      </tr>
                      <tr>
                        <td>Logo Sekolah</td><td style="width:15px;text-align:center;">:</td>
                        <td><img src="<?= base_url() ?>panel/dist/upload/logo/<?= $sekolah['logo'] ?>" class="img-profile" style="width: 15rem;" /></td>
                      </tr>
                    </table>  
                  </div>       
              </div>              
