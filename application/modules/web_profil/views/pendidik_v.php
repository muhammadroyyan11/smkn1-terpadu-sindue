                      ...
                      <tr>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="foto-table"><div class="small-photo imagefull"><a href="<?= base_url() ?>panel/dist/upload/profil_guru/<?= $guru['gambar'] ?>"  data-fancybox="images" data-caption="<?= $guru['nama_guru'] ?>"><img src="<?= base_url() ?>panel/dist/upload/profil_guru/<?= $guru['gambar'] ?>"></a></div></td>
                            <td>
                                <b><?= $guru['nama_guru'] ?></b><br/>
                                <span class="mob-v">Tugas <br/></span>
                                <?= $guru['mengajar'] ?>					
                            </td>                           
                          </tr> 
                          <?php endforeach ?>                       
