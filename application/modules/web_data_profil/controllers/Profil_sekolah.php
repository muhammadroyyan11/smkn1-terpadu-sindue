...
class Profil_sekolah extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('npyp', 'NPYP', 'required');
        $this->form_validation->set_rules('nss', 'NSS', 'required');
        $this->form_validation->set_rules('nds', 'NDS', 'required');
        ...
        $this->form_validation->set_rules('sekola_status', 'Negeri / Swasta', 'required');
        $this->form_validation->set_rules('sekolah_waktu', 'Pagi / 6 hari', 'required');
        $this->form_validation->set_rules('sekolah_jenjang', 'Tk/SD/SMP/SMA/SMK', 'required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data =
                [
                    'npyp' => $this->input->post('npyp'),
                    'nss' => $this->input->post('nss'),
                    'nds' => $this->input->post('nds'),
                    ...
                    'sekola_status' => $this->input->post('sekola_status'),
                    'sekolah_waktu' => $this->input->post('sekolah_waktu'),
                    'sekolah_jenjang' => $this->input->post('sekolah_jenjang'),                 
                    'is_active' => 1,
                    'is_active_psb' => 1,
                    'active_banner' => 1,
                ];
    ...
    public function data_maps_kecil()
    {
        $this->form_validation->set_rules('maps_kecil', 'Maps Kecil', 'required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data =
                [
                    'maps_kecil' => $this->input->post('maps_kecil'),
                ];
    ...
    public function data_maps_sedang()
    {
        $this->form_validation->set_rules('maps_sedang', 'Maps Sedang', 'required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data =
                [
                    'maps_sedang' => $this->input->post('maps_sedang'),
                ];
