<div class="modal fade modal-action" id="modal-lg">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open_multipart(base_url('master_pegawai/data_pegawai/simpan_tambah')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" autocomplete="off" name="nik" id="nik" maxlength="25" required class="form-control" placeholder="NIK">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
