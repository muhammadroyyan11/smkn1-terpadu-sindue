         ...
         <div class="modal-content">
             <div class="modal-lg">
                 <div class="card card-primary card-outline">
                     ...
                     <!-- /.card-header -->
                     <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/simpan_tambah_pengumuman" role="form" id="form-action" enctype="multipart/form-data">
                         <div class="card-body">
                             ...
                             <div class="modal-body">
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <textarea class="form-control" id="ckeditor" name="deskripsi" rows="3" data-form-field="Pengumuman" placeholder="" autofocus="" style="display: none;"></textarea>
                                 </div>
                             </div>
