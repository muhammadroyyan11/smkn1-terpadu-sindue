         ...
         <div class="modal-content">
             <div class="modal-lg">
                 <div class="card card-primary card-outline">
                     ...
                     <!-- /.card-header -->
                     <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/simpan_edit_pengumuman" role="form" id="form-action" enctype="multipart/form-data">
                         <div class="card-body">

                             <div class="modal-body">
                                 <input type="hidden" value="<?= $pengumuman['id'] ?>" name="id" class="form-control" required="">
                                 <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <textarea name="deskripsi" id="ckeditor" class="summernote"><?= $pengumuman['deskripsi'] ?></textarea>
                                 </div>
                             </div>
