                            ...
                            <tbody>
                                ...
                                foreach ($belum_bayar as $bb) :
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url() ?>ppdb_admin_biaya/cek_verifikasi_biaya/<?= $bb['id_bayar'] ?>" class="btn btn-sm btn-success btn-chek mb-2"><i class="fas fa-check-circle"></i> </a>
                                            <a href="<?= base_url() ?>ppdb_admin_biaya/deldata_verifikasi_biaya/<?= $bb['id_bayar'] ?>" class="btn btn-sm btn-danger btn-delete mb-2"><i class="fa fa-trash-alt"></i> </a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                foreach ($sudah_bayar as $sb) :
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url() ?>ppdb_admin_biaya/uncek_verifikasi_biaya/<?= $sb['id_bayar'] ?>" class="btn btn-sm  btn-danger btn-chek"><i class="fas fa-times-circle"></i> </a>
                                            <a target="_blank" href="<?= base_url() ?>ppdb_admin_biaya/print_kwitansi/<?= $sb['id_bayar'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-print"></i></a>
                                            <!-- <a href="<?= base_url() ?>ppdb_admin_biaya/deldata_verifikasi_biaya/<?= $sb['id_bayar'] ?>" class="btn btn-sm btn-danger btn-delete"><i class="fa fa-trash-alt"></i> </a> -->
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
