                    ...
                    <form action="" id="FormBayar">
                        <div class="form-row">
                            <div class="col-md-6 col-xs-6">
                                <div class="mb-3">
                                    <select class="form-control" style="width: 100%" name="data" id="data" required>
                                        <option>Cari Data Pendaftar</option>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($bayar['verifikasi'] == 1) { ?>
                                                    <span class="btn btn-success btn-sm">Sudah Dicek</span>
                                                <?php } else { ?>
                                                    <span class="btn btn-warning btn-sm">Belum Dicek</span>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <a target="_blank" href="<?= base_url() ?>ppdb_admin_biaya/print_kwitansi/<?= $bayar['id_bayar'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-print"></i></a>
                                                <a href="<?= base_url() ?>ppdb_admin_biaya/hapus_pembayaran/<?= $bayar['id_bayar'] ?>" class="hapus btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
