...
class Ppdb_admin_biaya extends CI_Controller
{
    ...
    public function master_biaya()
    {
        ...
        $this->load->view('ppdb_admin_biaya/biaya/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_biaya/biaya/biaya_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_biaya/biaya/list_js');
    ...
    public function tambah()
    {
        ...
        $this->load->view('ppdb_admin_biaya/biaya/list_css');
        $this->load->view('ppdb_admin_biaya/biaya/biaya_add', $data);
        $this->load->view('ppdb_admin_biaya/biaya/list_js');
    }
    ...
    function edit($id)
    {
        ...
        $this->load->view('ppdb_admin_biaya/biaya/list_css');
        $this->load->view('ppdb_admin_biaya/biaya/biaya_edit', $data);
        $this->load->view('ppdb_admin_biaya/biaya/list_js');
    }
    ...
    public function simpan_tambah()
    {
        ...
        redirect('ppdb_admin_biaya/master_biaya');
    }
    ...
    public function pembayaran()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('layout/header-top', $data);
            $this->load->view('ppdb_admin_biaya/pembayaran/list_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('ppdb_admin_biaya/pembayaran/pembayaran_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('ppdb_admin_biaya/pembayaran/list_js');
            $this->load->view('layout/footer-bottom');
            $this->benchmark->mark('code_end');
        } else {
            $today = date("Ymd");
            ...
            if ($bukti) {
                ...
                if (!$this->upload->do_upload('bukti')) {
                    ...
                    redirect('ppdb_admin_biaya/pembayaran');
                }
            }
        }
    }
    ...
    public function data_bayar($id)
    {
        ...
        $this->load->view('ppdb_admin_biaya/pembayaran/pembayaran_data', $data);
        $this->load->view('ppdb_admin_biaya/pembayaran/list_js');
    }
    ...
    public function tambah_bayar()
    {
        ...
        $this->load->view('ppdb_admin_biaya/pembayaran/list_css');
        $this->load->view('ppdb_admin_biaya/pembayaran/pembayaran_add', $data);
        $this->load->view('ppdb_admin_biaya/pembayaran/list_js');
    }
    ...
    public function bukti_pembayaran_1($id)
    {
        ...
        $this->load->view('ppdb_admin_biaya/pembayaran/list_css');
        $this->load->view('ppdb_admin_biaya/pembayaran/pembayaran_bukti_1', $data);
        $this->load->view('ppdb_admin_biaya/pembayaran/list_js');
    }
    ...
    public function bukti_pembayaran_2($id)
    {
        $data['bayar'] = $this->psb->getDetailBayar($id);
        $this->load->view('ppdb_admin_biaya/pembayaran/list_css');
        $this->load->view('ppdb_admin_biaya/pembayaran/pembayaran_bukti_2', $data);
        $this->load->view('ppdb_admin_biaya/pembayaran/list_js');
    }
    ...
    public function verifikasi_biaya()
    {
        ...
        // die;
        $this->load->view('layout/header-top', $data);
        $this->load->view('ppdb_admin_biaya/verifikasi_biaya/list_css');
        $this->load->view('layout/header-bottom', $data);
        $this->load->view('layout/main-navigation', $data);
        $this->load->view('ppdb_admin_biaya/verifikasi_biaya/verifikasi_biaya_v', $data);
        $this->load->view('layout/footer-top');
        $this->load->view('ppdb_admin_biaya/verifikasi_biaya/list_js');
        $this->load->view('layout/footer-bottom');
        $this->benchmark->mark('code_end');
    }
    ...
    public function deldata_verifikasi_biaya($id)
    {
        ...
        $this->db->delete('ppdb_bayar', $data);
        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert"> Berhasil hapus data !!!</div>');
        redirect('ppdb_admin_biaya/verifikasi_biaya');
    }
    ...
    public function print_kwitansi($id_bayar)
    {
        ...
        // Set the new Footer after you AddPage
        $mpdf->SetHTMLFooter();
        $html1 = $this->load->view('ppdb_admin_biaya/verifikasi_biaya/print_kwitansi', $data, TRUE);
        $mpdf->WriteHTML($html1);
