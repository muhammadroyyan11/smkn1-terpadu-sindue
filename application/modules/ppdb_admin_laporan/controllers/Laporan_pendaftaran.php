...
class Laporan_pendaftaran extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('Laporan_pendaftaran_model', 'ion_auth');
    }
    ...
    public function tabel($target)
    {
        ...
        $daftar =
                $this->db->select('a.*')
                ->from('ppdb_daftar a')                           
                ->where(['a.tahun_daftar' => $target])
                ->group_by('a.no_daftar', 'ASC')
                ->get()->result_array();            
                                ...
                                <tbody>';
                                    if (!empty($daftar)) {
                                        ...
                                        foreach ($daftar as $df) {                                    
                                            $html .= '<td>' . $no++ . '</td><td>' . $df['no_daftar'] . '</td><td>' . $df['nama'] . '</td><td>' . $df['tempat_lahir'] . '</td><td>' . $df['tgl_lahir'] . '</td><td>' . $df['agama'] . '</td><td>' . $df['jenis_daftar'] . '</td></tr>';
                                        }
                                    }';                       
                                </tbody>
                            </table>
