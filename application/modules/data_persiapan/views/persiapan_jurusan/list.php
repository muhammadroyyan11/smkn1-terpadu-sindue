                            ...
                            <tbody>
                                ...
                                <?php foreach ($jurusan->result() as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r->jurusan; ?></td>
                                        <td>
                                            <a class="btn btn-warning" href="" data-jurusan="<?= $r->jurusan; ?>" data-id="<?= $r->kode_jurusan; ?>" data-bs-toggle="modal" data-bs-target="#editModal" title="Edit"><i class="bi bi-pencil-square"></i></a>
                                            <a href="<?= base_url('data_persiapan/persiapan_jurusan/deljurusan/') . $r->kode_jurusan; ?>" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
...
<div class="modal fade" id="newRoleModal" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('data_persiapan/persiapan_jurusan'); ?>" method="post">              
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="newRoleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('data_persiapan/persiapan_jurusan/editjurusan'); ?>" method="post">               
                <div class=" modal-body">
                    <input type="hidden" class="form-control" name="npsn" value="<?= $pegawai['npsn']?>">
                    <!-- <input type="hidden" class="form-control" id="ed_id" name="ed_id"> -->
                    <div class="mb-3">
                        <input type="text" class="form-control" id="ed_id" name="ed_id" placeholder="Kode Jurusan">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="ed_jurusan" name="ed_jurusan" placeholder="Nama Jurusan">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<script>
    $(function() {
        $('#editModal').on('show.bs.modal', function(e) {
            ...
            let id = btn.data('id');
            let jurusan = btn.data('jurusan');           
            $("#ed_id").val(id);
            $("#ed_jurusan").val(jurusan);          
        });
    })
</script>