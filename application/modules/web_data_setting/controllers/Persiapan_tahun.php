...
class Persiapan_tahun extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('th_pelajaran', 'Tahun', 'required');
        $this->form_validation->set_rules('semester', 'Semester', 'required');

        if ($this->form_validation->run() == false) {
            $this->benchmark->mark('code_start');
            $data['title'] = 'Master Tahun';
            $data['home'] = 'Web Setting';
            ...
            $this->load->view('web_data_setting/persiapan_tahun/list', $data);
           ...
           Berhasi Tambah Data !</div>');
            redirect('web_data_setting/persiapan_tahun');
        }
    }
