<div class="card-header">
    <span style="float: right">
        <a target="_blank" href="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/print_lulus/<?= $lulus['lulus_id'] ?>" type="button" class="btn btn-success btn-right"><i class="fas fa-print"></i> Cetak SKL</a>
    </span>
