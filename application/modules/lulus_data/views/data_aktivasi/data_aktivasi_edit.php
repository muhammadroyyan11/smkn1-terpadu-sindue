        ...
        <div class="modal-content">
            <div class="modal-lg">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/ubah" role="form" id="form-action" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="row">                                   
                                <div class="col-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="no_surat" value="<?= $alumni['no_surat'] ?>" class="form-control"  placeholder="No Surat" autocomplete="off" required>
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tahun_pelajaran" name="tahun_pelajaran" value="<?= $alumni['tahun_pelajaran'] ?>" class="form-control" placeholder="Tahun Pelajaran">
                            ...
                            <div class="row">                                   
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="keterangan" name="keterangan" value="<?= $alumni['keterangan'] ?>" class="form-control" placeholder="alumni / Tidak alumni">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <input type="text" id="alamat_siswa" name="alamat_siswa" value="<?= $alumni['alamat_siswa'] ?>" class="form-control" placeholder="Alamat Siswa">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="alumni_aktif" value="1" class="selectgroup-input" checked="">
                                        <span class="selectgroup-button">Aktif</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="alumni_aktif" value="2" class="selectgroup-input">
