        ...
        <div class="modal-content">
            <div class="modal-lg">
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <form method="post" action="<?= base_url() . $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'both') ?>/simpan" role="form" id="form-action" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="row">  
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" minlength="3" maxlength="18" name="nis" class="form-control"  placeholder="NIS" autocomplete="off" required>
