  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        ...
        <li><a href="<?= base_url('lulus/info') ?>" class="nav-link scrollto <?= ('lulus/info' == $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'leading') ? 'active' : '') ?>"><i class="bx bx-volume-low"></i> <span>Informasi</span></a></li>
        <li><a href="<?= base_url('lulus/lulus_form') ?>" class="nav-link scrollto <?= ('lulus/lulus_form' == $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'leading') ? 'active' : '') ?>"><i class="bx bx-file-blank"></i> <span>Cetak SKL</span></a></li>
        <li><a href="<?= base_url('lulus/login') ?>" class="nav-link scrollto <?= ('lulus/login' == $this->uri->segment(1, 0) . $this->uri->slash_segment(2, 'leading') ? 'active' : '') ?>"><i class="bx bx-user-circle"></i> <span>Login</span></a></li>
      </ul>
    </nav><!-- .nav-menu -->
